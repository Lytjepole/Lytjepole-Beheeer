Ext.define('LPB.view.user.useritems.windows.AddUserItemWindow', {
    extend: 'Ext.window.Window',
    alias: 'widget.adduseritemwindow',
    ...
    listeners: {
        beforeclose: 'onBeforeAddItemWindowClose'
    },
    ...
    initComponent: function () {
        this.items = [{
            ...
            listeners: {
                scope: this,
                afterrender: 'addItemFormRendered'
            },
