Ext.define('LPB.view.admin.items.windows.EditItem', {
    extend: 'Ext.window.Window',

    xtype: 'edititemwindow',
    alias: 'edititemwindow',
    ...
    listeners: {
        beforeclose: 'onEditItemWindowBeforeClose'
    },
    ...
    initComponent: function () {
        this.items = [{
            ...
            listeners: {
                scope: this,
                afterrender: this.editItemFormAfterRender
            },
    ...
    editItemFormAfterRender: function (form) {
    ...
    setCategories: function (id) {
        Ext.Ajax.request({
            scope: this,
            url: 'resources/data/category/category.php?action=getCategories&id=' + id,
    ...
    setGroup: function (id) {
        Ext.Ajax.request({
            scope: this,
            url: 'resources/data/group/group.php?action=getGroup&id=' + id,
            success: function (response, eOpts) {
